...
for i = 1 : length(model_name) % 选择模式读取数据
    for j = 1 : length(SSP_type)
        save_peth_1 = 'J:\6-硕士毕业论文\1-Data\CMIP6-Tas-Pr-2015-2100\10-4-30a-all-pre-R95\pre_amount_percentage_and_pre_intervals\';
        cd(save_peth_1)
        load([model_name{i},'_',SSP_type{j},'_1985_2014_Pre_intervals_of_pre_event_thresold_5_95_in_cell.mat'])
        load([model_name{i},'_',SSP_type{j},'_1985_2014_Pre_amount_percentage_of_pre_event_thresold_5_95_in_cell.mat'])
        ...
        save(['J:\6-硕士毕业论文\1-Data\CMIP6-Tas-Pr-2015-2100\10-4-30a-all-pre-R95\Heavy_rain_percentage_and_Moderate_rain_intervals_3D_matrix\',filename],...
        ...
        save(['J:\6-硕士毕业论文\1-Data\CMIP6-Tas-Pr-2015-2100\10-4-30a-all-pre-R95\Heavy_rain_percentage_and_Moderate_rain_intervals_3D_matrix\',filename2],...
...
for j = 1 : length(SSP_type)
    ...
    for year = 1 : 30
        ...
        for i = 1 : length(model_name) % 选择模式读取数据
            ...
            filename = [model_name{i},'_',SSP_type{j},'_heavy_rain_percentage_025_scale_pre_event_thresold_5_95_matrix.mat'];
            load(['J:\6-硕士毕业论文\1-Data\CMIP6-Tas-Pr-2015-2100\10-4-30a-all-pre-R95\Heavy_rain_percentage_and_Moderate_rain_intervals_3D_matrix\',filename])
            filename2 = [model_name{i},'_',SSP_type{j},'_moderate_rain_intervals_025_scale_pre_event_thresold_5_95_matrix.mat'];
            load(['J:\6-硕士毕业论文\1-Data\CMIP6-Tas-Pr-2015-2100\10-4-30a-all-pre-R95\Heavy_rain_percentage_and_Moderate_rain_intervals_3D_matrix\',filename2])
    ...
    save(['J:\6-硕士毕业论文\1-Data\CMIP6-Tas-Pr-2015-2100\10-4-30a-all-pre-R95\Model_ensemble_Heavy_rain_percentage_and_Moderate_rain_intervals_3D_matrix\annual\',filename],...
    ...
    save(['J:\6-硕士毕业论文\1-Data\CMIP6-Tas-Pr-2015-2100\10-4-30a-all-pre-R95\Model_ensemble_Heavy_rain_percentage_and_Moderate_rain_intervals_3D_matrix\annual\',filename2],...
...
for j = 1 : length(SSP_type)
    ...
    save(['J:\6-硕士毕业论文\1-Data\CMIP6-Tas-Pr-2015-2100\10-4-30a-all-pre-R95\Model_ensemble_Heavy_rain_percentage_and_Moderate_rain_intervals_3D_matrix\climatic\',filename],...
    ...
    save(['J:\6-硕士毕业论文\1-Data\CMIP6-Tas-Pr-2015-2100\10-4-30a-all-pre-R95\Model_ensemble_Heavy_rain_percentage_and_Moderate_rain_intervals_3D_matrix\climatic\',filename2],...
