...
for i = 1 : length(Temporal_scale_name)
    for j = 1 : length(climate_zone_name)
        ...
        eval(['heavy_rain_fre_',Temporal_scale_name{i},'_',climate_zone_name{j},' = nan(size(Gini_CMFD_3h_1985_2014,3),length(k_',climate_zone_name{j},'));'])
        ...
        eval(['PCCs_GI_and_heavy_rain_fre_',Temporal_scale_name{i},'_',climate_zone_name{j},' = nan(1,length(k_',climate_zone_name{j},'));'])
        ...
        eval(['P_GI_and_heavy_rain_fre_',Temporal_scale_name{i},'_',climate_zone_name{j},' = nan(1,length(k_',climate_zone_name{j},'));'])
...
for i = 1 : length(Temporal_scale_name)
    for j = 1 : length(climate_zone_name)
        for year = 1 : size(Gini_CMFD_3h_1985_2014,3)
            ...
            eval(['heavy_rain_fre_',Temporal_scale_name{i},'_year = heavy_rain_fre_',Temporal_scale_name{i},'_matrix(:,:,year);'])
            ...
            eval(['heavy_rain_fre_',Temporal_scale_name{i},'_',climate_zone_name{j},'(year,:) = heavy_rain_fre_',Temporal_scale_name{i},'_year(k_',climate_zone_name{j},');'])
        ...
        eval(['clear GI_',Temporal_scale_name{i},'_year heavy_rain_fre_',Temporal_scale_name{i},'_year heavy_rain_amount_percentage_',Temporal_scale_name{i},'_year'])
    end
end
...
for i = 1 : length(Temporal_scale_name)
    for j = 1 : length(climate_zone_name)
        savepath2 = 'J:\6-硕士毕业论文\1-Data\CMFD\9-1-GI-and_heavy-rain-features-in-climate-zones\';
        filename2 = ['GI_and_heavy_rain_features_',Temporal_scale_name{i},'_',climate_zone_name{j},'.mat'];
        eval(['save([savepath2,filename2],''GI_',Temporal_scale_name{i},'_',climate_zone_name{j},''',''heavy_rain_fre_',Temporal_scale_name{i},'_',climate_zone_name{j},''',''heavy_rain_amount_percentage_',Temporal_scale_name{i},'_',climate_zone_name{j},''')'])
    end
end
...
for i = 1 : length(Temporal_scale_name)
    for j = 1 : length(climate_zone_name)
        ...
        for n = 1 : K_len
            ...
            eval(['Heavy_rain_fre_1 = heavy_rain_fre_',Temporal_scale_name{i},'_',climate_zone_name{j},'(:,n);'])
            eval(['Heavy_rain_amount_percentage_1 = heavy_rain_amount_percentage_',Temporal_scale_name{i},'_',climate_zone_name{j},'(:,n);'])
            
            [PCCs_1,P_1] = corrcoef(Heavy_rain_fre_1,GI_1);
            [PCCs_2,P_2] = corrcoef(Heavy_rain_amount_percentage_1,GI_1);
            
            eval(['PCCs_GI_and_heavy_rain_fre_',Temporal_scale_name{i},'_',climate_zone_name{j},'(n) = PCCs_1(2);'])
            eval(['PCCs_GI_and_heavy_rain_amount_percentage_',Temporal_scale_name{i},'_',climate_zone_name{j},'(n) = PCCs_2(2);'])
            eval(['P_GI_and_heavy_rain_fre_',Temporal_scale_name{i},'_',climate_zone_name{j},'(n) = P_1(2);'])
            eval(['P_GI_and_heavy_rain_amount_percentage_',Temporal_scale_name{i},'_',climate_zone_name{j},'(n) = P_2(2);'])
            
            clear PCCs_1 P_1 PCCs_2 P_2 GI_1 Heavy_rain_fre_1 Heavy_rain_amount_percentage_1
        end
        
        savepath2 = 'J:\6-硕士毕业论文\1-Data\PCCs-bewteen-Heavy-rain-features-and-GI\';
        filename2 = ['PCCs_GI_and_heavy_rain_fre_',Temporal_scale_name{i},'_',climate_zone_name{j},'.mat'];
        eval(['save([savepath2,filename2],''PCCs_GI_and_heavy_rain_fre_',Temporal_scale_name{i},'_',climate_zone_name{j},''',''P_GI_and_heavy_rain_fre_',Temporal_scale_name{i},'_',climate_zone_name{j},''')'])
