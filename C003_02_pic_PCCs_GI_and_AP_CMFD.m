%% 这个文件将CMFD数据计算得到的基尼系数与年降水量相关系数画成空间分布图
%% 研究时段为1985-2014
...
save_peth_1 = 'J:\6-硕士毕业论文\1-Data\PCCs-bewteen-AP-and-GI\';
cd(save_peth_1)
filename2 = 'PCCs_of_CMFD_AP_and_GI_01_scale_1985_2014.mat';
load(filename2)

mask_CN_PCCs_AP_group(Lon,Lat,PCCs_3h_GI_AP,PCCs_6h_GI_AP,PCCs_12h_GI_AP,...
    PCCs_1d_GI_AP,p_value_3h,p_value_6h,p_value_12h,p_value_1d,shp0,shp,shp1,shp2,-1,1,10,shp_line_HR,shp_line_TR,shp_line_AR,shp_line_TP)

%%
cd('F:\File_of_MATLAB\6-硕士毕业论文\4-pic\003-02-PCCs-AP-and-GI\CMFD\')
exportgraphics(gcf,['年降水量对降水集中度的影响-CMFD.jpg'])